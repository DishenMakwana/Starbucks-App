...
var cartRmv = document.querySelectorAll('.cartRmv');
...
var removeFromCart = function removeFromCart(cartRemovedPizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/updateRemove-cart', cartRemovedPizza).then(function (res) {
...
cartRmv.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var cartRemovePizza = JSON.parse(btn.dataset.pizzrmv);
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51Iwj4NSJyxj3EBBcPJHuTz9NPmFFcweEAJjReV0hQ0grZTMFY0KDnsdeVDi1InVM9tsGf8J646rfwuF88bsDvjcU00qFGP53Y0');
